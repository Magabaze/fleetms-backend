...
<head>
    <meta charset="UTF-8">
    <title>Abastecimento Externo - {{ $abastecimento->numero }}</title>
...
<div class="container">
    ...
    <div class="section">
        ...
        <table class="data-table">
            ...
            <tr>
                ...
                <td class="label-cell">Nota Fiscal:</td>
    ...
    <div class="section">
        <div class="section-title">Informações do Posto</div>
        <table class="data-table">
            <tr>
                <td class="label-cell">Posto:</td>
                <td>{{ $abastecimento->posto->nome ?? $abastecimento->posto_nome ?? 'N/A' }}</td>
                <td class="label-cell">Localização:</td>
                <td>{{ $abastecimento->posto->localizacao ?? 'N/A' }}</td>
            </tr>
        </table>
    </div>
        ...
        <table class="data-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="text-right">{{ number_format($abastecimento->quantidade, 2, ',', '.') }}</td>
                    <td class="text-right">{{ number_format($abastecimento->preco_unitario, 2, ',', '.') }} {{ $abastecimento->moeda }}</td>
                    <td class="text-right">{{ number_format($abastecimento->quantidade * $abastecimento->preco_unitario, 2, ',', '.') }} {{ $abastecimento->moeda }}</td>
                    <td class="text-center">
                        ...
                        @elseif(in_array($abastecimento->status, ['pago', 'realizado']))
                            <span class="badge badge-pago">PAGO</span>
                        @elseif(in_array($abastecimento->status, ['rejeitado', 'cancelado']))
    ...
    <div class="total-box">
        <div class="total-value">
            {{ number_format($abastecimento->quantidade * $abastecimento->preco_unitario, 2, ',', '.') }} {{ $abastecimento->moeda }}
        </div>
    ...
    <div class="section">
        ...
        <table class="data-table">
            <tr>
                ...
                <td>{{ isset($abastecimento->data_registro) ? date('d/m/Y H:i', strtotime($abastecimento->data_registro)) : 'N/A' }}</td>
            </tr>
            ...
            <tr>
                <td class="label-cell">Pago por:</td>
        ...
        <table class="signature-table">
            <tr>
                ...
                <td>
                    ...
                    <div style="font-size: 9px; color: #555;">{{ $usuario ?? 'Sistema' }}</div>
                </td>
            </tr>
        </table>
    </div>
