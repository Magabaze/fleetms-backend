...
<head>
    ...
    <style>
        ...
        /* ===== IMPRESSÃO ===== */
        @media print {
            .badge-pendente, .badge-progresso, .badge-concluida, 
            .badge-cancelada, .badge-baixa, .badge-media, .badge-alta,
...
<div class="container">
    ...
    <table class="header-table">
        <tr>
            ...
            <td class="title-cell">
                ...
                <div class="doc-subtitle">Documento de Autorização de Reparação</div>
    ...
    <div class="section">
        ...
        <table class="data-table">
            ...
            <tr>
                ...
                <td>
                    <span class="badge badge-{{ $ordem->prioridade }}">
                        {{ $prioridade_label }}
                    </span>
                </td>
                <td class="label-cell">Status:</td>
                <td>
                    <span class="badge badge-{{ $ordem->status }}">
                        {{ $status_label }}
                    </span>
                </td>
            </tr>
            <tr>
                <td class="label-cell">Data Criação:</td>
                <td>{{ $data_criacao }}</td>
                <td class="label-cell">Data Prevista:</td>
                <td>{{ $data_prevista }}</td>
            </tr>
        </table>
    </div>
    ...
    <div class="section">
        ...
        <table class="data-table">
            <tr>
                <td style="background: #fafafa;">{{ $ordem->descricao }}</td>
            </tr>
        </table>
    </div>
    ...
    <div class="signatures">
        <div class="signatures-title">Assinaturas e Autorização</div>
        <table class="signature-table">
            <tr>
                <td>
                    <div class="signature-line"></div>
                    <div style="font-weight: bold;">TÉCNICO RESPONSÁVEL</div>
                    <div style="font-size: 9px; color: #555;">{{ $ordem->tecnico }}</div>
                </td>
                <td>
                    <div class="signature-line"></div>
